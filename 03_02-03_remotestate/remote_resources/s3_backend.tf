...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "infotitans-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "infotitans-tfremotestate" {
  bucket = aws_s3_bucket.infotitans-tfremotestate.id
